...
4. Insert every verified Stripe webhook event with `ON CONFLICT (event_id) DO NOTHING` before changing a subscription or referral. This makes provider retries idempotent.
