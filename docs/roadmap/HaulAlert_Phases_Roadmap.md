...
- [x] **P8.4** Build broker profiles, broker search, and customer-managed blocked-broker lists.
- [x] **P8.5** Implement plan entitlement checks and subscription lifecycle management.
